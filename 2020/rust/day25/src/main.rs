...
// finally reach the door to your room, swipe your card, and - beep - the light
// turns red.
//
...
// for you." Still catching your breath, you describe the status of the
...
// knows how to fix it! We've already dispatched a reindeer to your location to
// pick you up."
//
...
fn main() {
    ...
    // Puzzle input
    let key_public_card: usize = 11239946;
    let key_public_door: usize = 10464955;
